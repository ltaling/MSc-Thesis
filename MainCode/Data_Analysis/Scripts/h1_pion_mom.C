// This macro draws the 1 dimensional histogram of pion momentum
...
void h1_pion_mom (std::string file_name, bool pimin, bool pi0, bool piplu){
  ...
  TH1F* h1_pi_mom_0[6]; //pi-
  TH1F* h1_pi_mom_1[6]; //pi0
  TH1F* h1_pi_mom_2[6]; //pi+
  TH1F* h1_toPlot[4]; //things to actually plot
  // Drawing histograms
  if (pimin){
    h1_pi_mom_0[0] = (TH1F*)input1->Get(TString::Format("h1_pion_momentum_interaction_1_type_0")); //QES
    h1_pi_mom_0[1] = (TH1F*)input1->Get(TString::Format("h1_pion_momentum_interaction_2_type_0")); //MEC
    h1_pi_mom_0[2] = (TH1F*)input1->Get(TString::Format("h1_pion_momentum_interaction_3_type_0")); //OtherRES
    h1_pi_mom_0[3] = (TH1F*)input1->Get(TString::Format("h1_pion_momentum_interaction_4_type_0")); //DIS
    h1_pi_mom_0[4] = (TH1F*)input1->Get(TString::Format("h1_pion_momentum_interaction_5_type_0")); //1232RES
    h1_pi_mom_0[5] = (TH1F*)input1->Get(TString::Format("h1_pion_momentum_interaction_0_type_0")); //Other
    if (h1_stacked[2] == nullptr){
      types = types + "#pi^{-}";
      h1_stacked[0] = h1_pi_mom_0[0];
      h1_stacked[1] = h1_pi_mom_0[1];
      h1_stacked[2] = h1_pi_mom_0[2];
      h1_stacked[3] = h1_pi_mom_0[3];
      h1_stacked[4] = h1_pi_mom_0[4];
      h1_stacked[5] = h1_pi_mom_0[5];
      }
    else{
      types = types + " & #pi^{-}";
      h1_stacked[0]->Add(h1_pi_mom_0[0]);
      h1_stacked[1]->Add(h1_pi_mom_0[1]);
      h1_stacked[2]->Add(h1_pi_mom_0[2]);
      h1_stacked[3]->Add(h1_pi_mom_0[3]);
      h1_stacked[4]->Add(h1_pi_mom_0[4]);
      h1_stacked[5]->Add(h1_pi_mom_0[5]);
    }
  }
  if (pi0){
    h1_pi_mom_1[0] = (TH1F*)input1->Get(TString::Format("h1_pion_momentum_interaction_1_type_1")); //QES
    h1_pi_mom_1[1] = (TH1F*)input1->Get(TString::Format("h1_pion_momentum_interaction_2_type_1")); //MEC
    h1_pi_mom_1[2] = (TH1F*)input1->Get(TString::Format("h1_pion_momentum_interaction_3_type_1")); //OtherRES
    h1_pi_mom_1[3] = (TH1F*)input1->Get(TString::Format("h1_pion_momentum_interaction_4_type_1")); //DIS
    h1_pi_mom_1[4] = (TH1F*)input1->Get(TString::Format("h1_pion_momentum_interaction_5_type_1")); //1232RES
    h1_pi_mom_1[5] = (TH1F*)input1->Get(TString::Format("h1_pion_momentum_interaction_0_type_1")); //Other
    if (h1_stacked[2] == nullptr){
      types = types + "#pi^{0}";
      h1_stacked[0] = h1_pi_mom_1[0];
      h1_stacked[1] = h1_pi_mom_1[1];
      h1_stacked[2] = h1_pi_mom_1[2];
      h1_stacked[3] = h1_pi_mom_1[3];
      h1_stacked[4] = h1_pi_mom_1[4];
      h1_stacked[5] = h1_pi_mom_1[5];
      }
    else{
      types = types + " & #pi^{0}";
      h1_stacked[0]->Add(h1_pi_mom_1[0]);
      h1_stacked[1]->Add(h1_pi_mom_1[1]);
      h1_stacked[2]->Add(h1_pi_mom_1[2]);
      h1_stacked[3]->Add(h1_pi_mom_1[3]);
      h1_stacked[4]->Add(h1_pi_mom_1[4]);
      h1_stacked[5]->Add(h1_pi_mom_1[5]);
    }
  }
  if (piplu){
    h1_pi_mom_2[0] = (TH1F*)input1->Get(TString::Format("h1_pion_momentum_interaction_1_type_2")); //QES
    h1_pi_mom_2[1] = (TH1F*)input1->Get(TString::Format("h1_pion_momentum_interaction_2_type_2")); //MEC
    h1_pi_mom_2[2] = (TH1F*)input1->Get(TString::Format("h1_pion_momentum_interaction_3_type_2")); //OtherRES
    h1_pi_mom_2[3] = (TH1F*)input1->Get(TString::Format("h1_pion_momentum_interaction_4_type_2")); //DIS
    h1_pi_mom_2[4] = (TH1F*)input1->Get(TString::Format("h1_pion_momentum_interaction_5_type_2")); //1232RES
    h1_pi_mom_2[5] = (TH1F*)input1->Get(TString::Format("h1_pion_momentum_interaction_0_type_2")); //Other
    if (h1_stacked[2] == nullptr){
      types = types + "#pi^{+}";
      h1_stacked[0] = h1_pi_mom_2[0];
      h1_stacked[1] = h1_pi_mom_2[1];
      h1_stacked[2] = h1_pi_mom_2[2];
      h1_stacked[3] = h1_pi_mom_2[3];
      h1_stacked[4] = h1_pi_mom_2[4];
      h1_stacked[5] = h1_pi_mom_2[5];
      }
    else{
      types = types + " & #pi^{+}";
      h1_stacked[0]->Add(h1_pi_mom_2[0]);
      h1_stacked[1]->Add(h1_pi_mom_2[1]);
      h1_stacked[2]->Add(h1_pi_mom_2[2]);
      h1_stacked[3]->Add(h1_pi_mom_2[3]);
      h1_stacked[4]->Add(h1_pi_mom_2[4]);
      h1_stacked[5]->Add(h1_pi_mom_2[5]);
    }
  }
  ...
  // formatting statements
     ...
     h1_toPlot[i]->Sumw2();
  //       h1_el_momentum_[i]->Scale( 1./h1_el_momentum_[i]->Integral(),"width"); // normalize the histogram to 1
     ...
     h1_toPlot[i]->GetXaxis()->SetTitle("Pion momentum (GeV/c)");
  ...
  //        h1_el_momentum[i]->GetYaxis()->SetTitleSize( 0.06);
     ...
     h1_toPlot[i]->SetTitle("Momentum Distribution of (1e"+TString(numProt)+"p1pi) Events "+TString(accept) + " for "+TString(types));
  ...
  save_file_path = "../output/h1_pion_mom/"+TString(energ)+TString(nucleus)+TString(cuts)+TString(particles)+TString(numProt)+"P"+TString(a)+".pdf";
