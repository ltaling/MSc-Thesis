// This file takes in GENIE Monte Carlo (MC) data for the He-4
...
// Users don't have to read all the code below this dashed line unless they want to do a deep dive into the code, or if they want to debug, etc.
	...
	std::string mc_file_path ("/pnfs/genie/persistent/users/smithja/e4nu_GENIE_simulation_output_files/4He_2261/");
	std::string data_file_path ("/pnfs/genie/persistent/users/smithja/e4nu_CLAS_data_output_files/4He_2261/");

	TFile *input;
	std::string file_names[ N_FILES];
	file_names[0] =	mc_file_path + "genie_target4He_beamEnergy2261_elSectors126_deltaPhiElEq12pt00_thetaEl20pt00to25pt00_elMomLBEq1pt90_MottXSecEq1.root";
	file_names[1] =	mc_file_path + "genie_target4He_beamEnergy2261_elSectors126_deltaPhiElEq12pt00_thetaEl20pt00to25pt00_elMomLBEq1pt90_protSectors453_deltaPhiProtEq45pt00_thetaProt40pt00to80pt00_protMomLBEq0pt60_MottXSecEq1.root";
	file_names[2] = mc_file_path + "genie_target4He_beamEnergy2261_elSectors126_deltaPhiElEq12pt00_thetaEl30pt00to35pt00_elMomLBEq1pt65_MottXSecEq1.root";
        file_names[3] = mc_file_path + "genie_target4He_beamEnergy2261_elSectors126_deltaPhiElEq12pt00_thetaEl30pt00to35pt00_elMomLBEq1pt65_protSectors453_deltaPhiProtEq45pt00_thetaProt38pt00to62pt00_protMomLBEq0pt90_MottXSecEq1.root";
        file_names[4] = mc_file_path + "genie_target4He_beamEnergy2261_elSectors126_deltaPhiElEq12pt00_thetaEl40pt00to45pt00_elMomLBEq1pt40_MottXSecEq1.root";
        file_names[5] = mc_file_path + "genie_target4He_beamEnergy2261_elSectors126_deltaPhiElEq12pt00_thetaEl40pt00to45pt00_elMomLBEq1pt40_protSectors453_deltaPhiProtEq45pt00_thetaProt30pt00to50pt00_protMomLBEq1pt25_MottXSecEq1.root"; 
        file_names[6] = data_file_path + "data_target4He_beamEnergy2261_elSectors126_deltaPhiElEq12pt00_thetaEl20pt00to25pt00_elMomLBEq1pt90.root";
        file_names[7] = data_file_path + "data_target4He_beamEnergy2261_elSectors126_deltaPhiElEq12pt00_thetaEl20pt00to25pt00_elMomLBEq1pt90_protSectors453_deltaPhiProtEq45pt00_thetaProt40pt00to80pt00_protMomLBEq0pt60.root";
        file_names[8] = data_file_path + "data_target4He_beamEnergy2261_elSectors126_deltaPhiElEq12pt00_thetaEl30pt00to35pt00_elMomLBEq1pt65.root";
        file_names[9] = data_file_path + "data_target4He_beamEnergy2261_elSectors126_deltaPhiElEq12pt00_thetaEl30pt00to35pt00_elMomLBEq1pt65_protSectors453_deltaPhiProtEq45pt00_thetaProt38pt00to62pt00_protMomLBEq0pt90.root";
        file_names[10] = data_file_path + "data_target4He_beamEnergy2261_elSectors126_deltaPhiElEq12pt00_thetaEl40pt00to45pt00_elMomLBEq1pt40.root";
        file_names[11] = data_file_path + "data_target4He_beamEnergy2261_elSectors126_deltaPhiElEq12pt00_thetaEl40pt00to45pt00_elMomLBEq1pt40_protSectors453_deltaPhiProtEq45pt00_thetaProt30pt00to50pt00_protMomLBEq1pt25.root";	
...
//				h1_prot_mom_sectors_data[file_i%(N_FILES/2)][0]->Sumw2(); // update the errors as we compile; this should produce a lot of warning statements
	...
	for (int idx = 0; idx < N_RANGES; idx++) { 
		...
		mc_conglomerate_trans[idx] = h1_prot_mom_sectors_interactions_mc[2*idx+1][0][0]->Integral() / h1_prot_mom_sectors_interactions_mc[2*idx][0][0]->Integral();
		data_conglomerate_trans[idx] = h1_prot_mom_sectors_data[2*idx+1][0]->Integral() / h1_prot_mom_sectors_data[2*idx][0]->Integral();

		std::cout << "mc_conglomerate_trans[idx]: " << mc_conglomerate_trans[idx] << ", data_conglomerate_trans[idx]: " << data_conglomerate_trans[idx] << std::endl;
	
		// calculate the proton transparency histograms as a function of proton momentum from the respective proton momentum histograms
...
std::cout << "mc_avg_prot_mom[idx]: " << mc_avg_prot_mom[idx] << ", data_avg_prot_mom[idx]: " << data_avg_prot_mom[idx] << std::endl;
		...
		h1_prot_mom_sectors_interactions_mc[2*idx+1][0][0]->Sumw2();
                ...
                h1_prot_mom_sectors_interactions_mc[2*idx+1][0][0]->SetTitle("He-4 with 2.261 GeV Beam Energy (GENIE & CLAS)");
                ...
                h1_prot_mom_sectors_data[2*idx+1][0]->SetTitle("He-4 with 2.261 GeV Beam Energy (GENIE & CLAS)");
	}
	...
	c->Update();
	c->SaveAs(TString::Format("../output/trans_vs_prot_mom/trans_vs_prot_mom_target4He_beamEnergy2261_exclusivePlus.pdf"));
	...
	// draw the conglomerate histograms
	//for (int idx = 0; idx < N_RANGES; idx++) {
