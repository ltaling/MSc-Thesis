// This macro draws the 1 dimensional histogram of pion angle (theta)
...
void h1_pion_theta (std::string file_name, bool pimin, bool pi0, bool piplu){
  ...
  TH1F* h1_pi_theta_0[6]; //pi-
  TH1F* h1_pi_theta_1[6]; //pi0
  TH1F* h1_pi_theta_2[6]; //pi+
  TH1F* h1_toPlot[4]; //things to actually plot
  // Drawing histograms
  if (pimin){
    h1_pi_theta_0[0] = (TH1F*)input1->Get(TString::Format("h1_pion_theta_interaction_1_type_0")); //QES
    h1_pi_theta_0[1] = (TH1F*)input1->Get(TString::Format("h1_pion_theta_interaction_2_type_0")); //MEC
    h1_pi_theta_0[2] = (TH1F*)input1->Get(TString::Format("h1_pion_theta_interaction_3_type_0")); //OtherRES
    h1_pi_theta_0[3] = (TH1F*)input1->Get(TString::Format("h1_pion_theta_interaction_4_type_0")); //DIS
    h1_pi_theta_0[4] = (TH1F*)input1->Get(TString::Format("h1_pion_theta_interaction_5_type_0")); //1232RES
    h1_pi_theta_0[5] = (TH1F*)input1->Get(TString::Format("h1_pion_theta_interaction_0_type_0")); //Other
    if (h1_stacked[2] == nullptr){
      types = types + "#pi^{-}";
      h1_stacked[0] = h1_pi_theta_0[0];
      h1_stacked[1] = h1_pi_theta_0[1];
      h1_stacked[2] = h1_pi_theta_0[2];
      h1_stacked[3] = h1_pi_theta_0[3];
      h1_stacked[4] = h1_pi_theta_0[4];
      h1_stacked[5] = h1_pi_theta_0[5];
      }
    else{
      types = types + " & #pi^{-} ";
      h1_stacked[0]->Add(h1_pi_theta_0[0]);
      h1_stacked[1]->Add(h1_pi_theta_0[1]);
      h1_stacked[2]->Add(h1_pi_theta_0[2]);
      h1_stacked[3]->Add(h1_pi_theta_0[3]);
      h1_stacked[4]->Add(h1_pi_theta_0[4]);
      h1_stacked[5]->Add(h1_pi_theta_0[5]);
    }
  }
  if (pi0){
    h1_pi_theta_1[0] = (TH1F*)input1->Get(TString::Format("h1_pion_theta_interaction_1_type_1")); //QES
    h1_pi_theta_1[1] = (TH1F*)input1->Get(TString::Format("h1_pion_theta_interaction_2_type_1")); //MEC
    h1_pi_theta_1[2] = (TH1F*)input1->Get(TString::Format("h1_pion_theta_interaction_3_type_1")); //OtherRES
    h1_pi_theta_1[3] = (TH1F*)input1->Get(TString::Format("h1_pion_theta_interaction_4_type_1")); //DIS
    h1_pi_theta_1[4] = (TH1F*)input1->Get(TString::Format("h1_pion_theta_interaction_5_type_1")); //1232RES
    h1_pi_theta_1[5] = (TH1F*)input1->Get(TString::Format("h1_pion_theta_interaction_0_type_1")); //Other
    if (h1_stacked[2] == nullptr){
      types = types + "#pi^{0}";
      h1_stacked[0] = h1_pi_theta_1[0];
      h1_stacked[1] = h1_pi_theta_1[1];
      h1_stacked[2] = h1_pi_theta_1[2];
      h1_stacked[3] = h1_pi_theta_1[3];
      h1_stacked[4] = h1_pi_theta_1[4];
      h1_stacked[5] = h1_pi_theta_1[5];
      }
    else{
      types = types + " & #pi^{0}";
      h1_stacked[0]->Add(h1_pi_theta_1[0]);
      h1_stacked[1]->Add(h1_pi_theta_1[1]);
      h1_stacked[2]->Add(h1_pi_theta_1[2]);
      h1_stacked[3]->Add(h1_pi_theta_1[3]);
      h1_stacked[4]->Add(h1_pi_theta_1[4]);
      h1_stacked[5]->Add(h1_pi_theta_1[5]);
    }
  }
  if (piplu){
    h1_pi_theta_2[0] = (TH1F*)input1->Get(TString::Format("h1_pion_theta_interaction_1_type_2")); //QES
    h1_pi_theta_2[1] = (TH1F*)input1->Get(TString::Format("h1_pion_theta_interaction_2_type_2")); //MEC
    h1_pi_theta_2[2] = (TH1F*)input1->Get(TString::Format("h1_pion_theta_interaction_3_type_2")); //OtherRES
    h1_pi_theta_2[3] = (TH1F*)input1->Get(TString::Format("h1_pion_theta_interaction_4_type_2")); //DIS
    h1_pi_theta_2[4] = (TH1F*)input1->Get(TString::Format("h1_pion_theta_interaction_5_type_2")); //1232RES
    h1_pi_theta_2[5] = (TH1F*)input1->Get(TString::Format("h1_pion_theta_interaction_0_type_2")); //Other
    if (h1_stacked[2] == nullptr){
      types = types + "#pi^{+}";
      h1_stacked[0] = h1_pi_theta_2[0];
      h1_stacked[1] = h1_pi_theta_2[1];
      h1_stacked[2] = h1_pi_theta_2[2];
      h1_stacked[3] = h1_pi_theta_2[3];
      h1_stacked[4] = h1_pi_theta_2[4];
      h1_stacked[5] = h1_pi_theta_2[5];
      }
    else{
      types = types + " & #pi^{+}";
      h1_stacked[0]->Add(h1_pi_theta_2[0]);
      h1_stacked[1]->Add(h1_pi_theta_2[1]);
      h1_stacked[2]->Add(h1_pi_theta_2[2]);
      h1_stacked[3]->Add(h1_pi_theta_2[3]);
      h1_stacked[4]->Add(h1_pi_theta_2[4]);
      h1_stacked[5]->Add(h1_pi_theta_2[5]);
    }
  }
  ...
  // formatting statements
      ...
      h1_toPlot[i]->Sumw2();
  //       h1_el_thetaentum[i]->Scale( 1./h1_el_momentum[i]->Integral(),"width"); // normalize the histogram to 1
      ...
      h1_toPlot[i]->GetXaxis()->SetTitle("Pion #theta (degrees)");
  ...
  //        h1_el_momentum[i]->GetYaxis()->SetTitleSize( 0.06);
       ...
       h1_toPlot[i]->SetTitle("Theta Distribution of (1e"+TString(numProt)+"p1pi) Events "+TString(accept) + " for "+TString(types));
  ...
  for( int i = 0; i < 4; i++){
      ...
      h1_toPlot[i]->GetXaxis()->SetRangeUser( 0, 180); //Theta goes from 0-180 degrees
  ...
  save_file_path = "../output/h1_pion_theta/"+TString(energ)+TString(nucleus)+TString(cuts)+TString(particles)+TString(numProt)+"P"+TString(a)+".pdf";
