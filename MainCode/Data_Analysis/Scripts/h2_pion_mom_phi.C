// This simple macro creates the 2D histograms for the momentum and phi of the signal inducing pions
...
void h2_pion_mom_phi (std::string file_name, bool pimin, bool pi0, bool piplu){
  ...
  TH2F* h2_pi_mom_phi_0[5]; //pi-
  TH2F* h2_pi_mom_phi_1[5]; //pi0
  TH2F* h2_pi_mom_phi_2[5]; //pi+
  // Drawing histograms
  if (pimin){
    h2_pi_mom_phi_0[0] = (TH2F*)input1->Get(TString::Format("h2_pion_mom_phi_interaction_1_type_0")); //QES
    h2_pi_mom_phi_0[1] = (TH2F*)input1->Get(TString::Format("h2_pion_mom_phi_interaction_2_type_0")); //MEC
    h2_pi_mom_phi_0[2] = (TH2F*)input1->Get(TString::Format("h2_pion_mom_phi_interaction_3_type_0")); //RES
    h2_pi_mom_phi_0[3] = (TH2F*)input1->Get(TString::Format("h2_pion_mom_phi_interaction_4_type_0")); //DIS
    h2_pi_mom_phi_0[4] = (TH2F*)input1->Get(TString::Format("h2_pion_mom_phi_interaction_0_type_0")); //Other
    if (h2_stacked[2] == nullptr){
      types = types + "min";
      h2_stacked[0] = h2_pi_mom_phi_0[0];
      h2_stacked[1] = h2_pi_mom_phi_0[1];
      h2_stacked[2] = h2_pi_mom_phi_0[2];
      h2_stacked[3] = h2_pi_mom_phi_0[3];
      h2_stacked[4] = h2_pi_mom_phi_0[4];
      }
    else{
      types = types + " & min ";
      h2_stacked[0]->Add(h2_pi_mom_phi_0[0]);
      h2_stacked[1]->Add(h2_pi_mom_phi_0[1]);
      h2_stacked[2]->Add(h2_pi_mom_phi_0[2]);
      h2_stacked[3]->Add(h2_pi_mom_phi_0[3]);
      h2_stacked[4]->Add(h2_pi_mom_phi_0[4]);
    }
  }
  if (pi0){
    h2_pi_mom_phi_1[0] = (TH2F*)input1->Get(TString::Format("h2_pion_mom_phi_interaction_1_type_1")); //QES
    h2_pi_mom_phi_1[1] = (TH2F*)input1->Get(TString::Format("h2_pion_mom_phi_interaction_2_type_1")); //MEC
    h2_pi_mom_phi_1[2] = (TH2F*)input1->Get(TString::Format("h2_pion_mom_phi_interaction_3_type_1")); //RES
    h2_pi_mom_phi_1[3] = (TH2F*)input1->Get(TString::Format("h2_pion_mom_phi_interaction_4_type_1")); //DIS
    h2_pi_mom_phi_1[4] = (TH2F*)input1->Get(TString::Format("h2_pion_mom_phi_interaction_0_type_1")); //Other
    if (h2_stacked[2] == nullptr){
      types = types + "0";
      h2_stacked[0] = h2_pi_mom_phi_1[0];
      h2_stacked[1] = h2_pi_mom_phi_1[1];
      h2_stacked[2] = h2_pi_mom_phi_1[2];
      h2_stacked[3] = h2_pi_mom_phi_1[3];
      h2_stacked[4] = h2_pi_mom_phi_1[4];
      }
    else{
      types = types + " & 0";
      h2_stacked[0]->Add(h2_pi_mom_phi_1[0]);
      h2_stacked[1]->Add(h2_pi_mom_phi_1[1]);
      h2_stacked[2]->Add(h2_pi_mom_phi_1[2]);
      h2_stacked[3]->Add(h2_pi_mom_phi_1[3]);
      h2_stacked[4]->Add(h2_pi_mom_phi_1[4]);
    }
  }
  if (piplu){
    h2_pi_mom_phi_2[0] = (TH2F*)input1->Get(TString::Format("h2_pion_mom_phi_interaction_1_type_2")); //QES
    h2_pi_mom_phi_2[1] = (TH2F*)input1->Get(TString::Format("h2_pion_mom_phi_interaction_2_type_2")); //MEC
    h2_pi_mom_phi_2[2] = (TH2F*)input1->Get(TString::Format("h2_pion_mom_phi_interaction_3_type_2")); //RES
    h2_pi_mom_phi_2[3] = (TH2F*)input1->Get(TString::Format("h2_pion_mom_phi_interaction_4_type_2")); //DIS
    h2_pi_mom_phi_2[4] = (TH2F*)input1->Get(TString::Format("h2_pion_mom_phi_interaction_0_type_2")); //Other
    if (h2_stacked[2] == nullptr){
      types = types + "plus";
      h2_stacked[0] = h2_pi_mom_phi_2[0];
      h2_stacked[1] = h2_pi_mom_phi_2[1];
      h2_stacked[2] = h2_pi_mom_phi_2[2];
      h2_stacked[3] = h2_pi_mom_phi_2[3];
      h2_stacked[4] = h2_pi_mom_phi_2[4];
      }
    else{
      types = types + " & plus";
      h2_stacked[0]->Add(h2_pi_mom_phi_2[0]);
      h2_stacked[1]->Add(h2_pi_mom_phi_2[1]);
      h2_stacked[2]->Add(h2_pi_mom_phi_2[2]);
      h2_stacked[3]->Add(h2_pi_mom_phi_2[3]);
      h2_stacked[4]->Add(h2_pi_mom_phi_2[4]);
    }
  }
...
// formatting statements
      //h2_stacked[i]->Sumw2();
//        h2_el_momentum[i]->Scale( 1./h2_el_momentum[i]->Integral(),"width"); // normalize the histogram to 1
      ...
      h2_stacked[i]->GetYaxis()->SetTitle("Phi (degrees)");
...
//        h2_el_momentum[i]->GetXaxis()->SetTitleSize( 0.06);
//        h2_el_momentum[i]->GetYaxis()->SetTitleSize( 0.06);
...
//h2_stacked[i]->GetYaxis()->SetRangeUser( 0, hist_max*1.1); // smithja: hist_max mult. by 1.1 to give the graph some head room
  ...
  save_file_path = "../output/h2_pion_mom_phi/"+TString(energ)+TString(nucleus)+TString(cuts)+TString(particles)+TString(numProt)+"P"+TString(a)+".pdf";
