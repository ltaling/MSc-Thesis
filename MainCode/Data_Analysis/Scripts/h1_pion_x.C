// This macro creates a graph of the Bjorken x in pion production
...
void h1_pion_x (std::string file_name, bool pimin, bool pi0, bool piplu){
  ...
  if (pimin){
    ...
    if (h1_stacked[2] == nullptr){
      types = types + "#pi^{-}";
      h1_stacked[0] = h1_pi_x_0[0];
      h1_stacked[1] = h1_pi_x_0[1];
      h1_stacked[2] = h1_pi_x_0[2];
      h1_stacked[3] = h1_pi_x_0[3];
      h1_stacked[4] = h1_pi_x_0[4];
      h1_stacked[5] = h1_pi_x_0[5];
      }
    else{
      types = types + " & #pi^{-} ";
      h1_stacked[0]->Add(h1_pi_x_0[0]);
      h1_stacked[1]->Add(h1_pi_x_0[1]);
      h1_stacked[2]->Add(h1_pi_x_0[2]);
      h1_stacked[3]->Add(h1_pi_x_0[3]);
      h1_stacked[4]->Add(h1_pi_x_0[4]);
      h1_stacked[5]->Add(h1_pi_x_0[5]);
    }
  }
  if (pi0){
    ...
    if (h1_stacked[2] == nullptr){
      types = types + "#pi^{0}";
      h1_stacked[0] = h1_pi_x_1[0];
      h1_stacked[1] = h1_pi_x_1[1];
      h1_stacked[2] = h1_pi_x_1[2];
      h1_stacked[3] = h1_pi_x_1[3];
      h1_stacked[4] = h1_pi_x_1[4];
      h1_stacked[5] = h1_pi_x_1[5];
      }
    else{
      types = types + " & #pi^{0}";
      h1_stacked[0]->Add(h1_pi_x_1[0]);
      h1_stacked[1]->Add(h1_pi_x_1[1]);
      h1_stacked[2]->Add(h1_pi_x_1[2]);
      h1_stacked[3]->Add(h1_pi_x_1[3]);
      h1_stacked[4]->Add(h1_pi_x_1[4]);
      h1_stacked[5]->Add(h1_pi_x_1[5]);
    }
  }
  if (piplu){
    ...
    if (h1_stacked[2] == nullptr){
      types = types + "#pi^{+}";
      h1_stacked[0] = h1_pi_x_2[0];
      h1_stacked[1] = h1_pi_x_2[1];
      h1_stacked[2] = h1_pi_x_2[2];
      h1_stacked[3] = h1_pi_x_2[3];
      h1_stacked[4] = h1_pi_x_2[4];
      h1_stacked[5] = h1_pi_x_2[5];
      }
    else{
      types = types + " & #pi^{+}";
      h1_stacked[0]->Add(h1_pi_x_2[0]);
      h1_stacked[1]->Add(h1_pi_x_2[1]);
      h1_stacked[2]->Add(h1_pi_x_2[2]);
      h1_stacked[3]->Add(h1_pi_x_2[3]);
      h1_stacked[4]->Add(h1_pi_x_2[4]);
      h1_stacked[5]->Add(h1_pi_x_2[5]);
    }
  }
  ...
  //       h1_el_phientum[i]->Scale( 1./h1_el_momentum[i]->Integral(),"width"); // normalize the histogram to 1
      ...
      h1_toPlot[i]->GetXaxis()->SetTitle("Bjorken x");
  ...
  //        h1_el_momentum[i]->GetYaxis()->SetTitleSize( 0.06);
        ...
        h1_toPlot[i]->SetTitle("Bjorken X Distribution of (1e"+TString(numProt)+"p1pi) Events "+TString(accept) + " for "+TString(types));
  ...
  TLegend *legend = new TLegend( 0.6, 0.75, 1.05, 0.9);
  ...
  save_file_path = "../output/h1_pion_x/"+TString(energ)+TString(nucleus)+TString(cuts)+TString(particles)+TString(numProt)+"P"+TString(a)+".pdf";
