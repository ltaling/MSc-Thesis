// This macro draws the 1 dimensional histogram of the energy transferred, Q^2.
...
void h1_pion_q2 (std::string file_name, bool pimin, bool pi0, bool piplu){
  ...
  if (pimin){
    ...
    if (h1_stacked[2] == nullptr){
      types = types + "#pi^{-}";
      h1_stacked[0] = h1_pi_q2_0[0];
      h1_stacked[1] = h1_pi_q2_0[1];
      h1_stacked[2] = h1_pi_q2_0[2];
      h1_stacked[3] = h1_pi_q2_0[3];
      h1_stacked[4] = h1_pi_q2_0[4];
      h1_stacked[5] = h1_pi_q2_0[5];
      }
    else{
      types = types + " & #pi^{-} ";
      h1_stacked[0]->Add(h1_pi_q2_0[0]);
      h1_stacked[1]->Add(h1_pi_q2_0[1]);
      h1_stacked[2]->Add(h1_pi_q2_0[2]);
      h1_stacked[3]->Add(h1_pi_q2_0[3]);
      h1_stacked[4]->Add(h1_pi_q2_0[4]);
      h1_stacked[5]->Add(h1_pi_q2_0[5]);
    }
  }
  if (pi0){
    ...
    if (h1_stacked[2] == nullptr){
      types = types + "#pi^{0}";
      h1_stacked[0] = h1_pi_q2_1[0];
      h1_stacked[1] = h1_pi_q2_1[1];
      h1_stacked[2] = h1_pi_q2_1[2];
      h1_stacked[3] = h1_pi_q2_1[3];
      h1_stacked[4] = h1_pi_q2_1[4];
      h1_stacked[5] = h1_pi_q2_1[5];
      }
    else{
      types = types + " & #pi^{0}";
      h1_stacked[0]->Add(h1_pi_q2_1[0]);
      h1_stacked[1]->Add(h1_pi_q2_1[1]);
      h1_stacked[2]->Add(h1_pi_q2_1[2]);
      h1_stacked[3]->Add(h1_pi_q2_1[3]);
      h1_stacked[4]->Add(h1_pi_q2_1[4]);
      h1_stacked[5]->Add(h1_pi_q2_1[5]);
    }
  }
  if (piplu){
    ...
    if (h1_stacked[2] == nullptr){
      types = types + "#pi^{+}";
      h1_stacked[0] = h1_pi_q2_2[0];
      h1_stacked[1] = h1_pi_q2_2[1];
      h1_stacked[2] = h1_pi_q2_2[2];
      h1_stacked[3] = h1_pi_q2_2[3];
      h1_stacked[4] = h1_pi_q2_2[4];
      h1_stacked[5] = h1_pi_q2_2[5];
      }
    else{
      types = types + " & #pi^{+}";
      h1_stacked[0]->Add(h1_pi_q2_2[0]);
      h1_stacked[1]->Add(h1_pi_q2_2[1]);
      h1_stacked[2]->Add(h1_pi_q2_2[2]);
      h1_stacked[3]->Add(h1_pi_q2_2[3]);
      h1_stacked[4]->Add(h1_pi_q2_2[4]);
      h1_stacked[5]->Add(h1_pi_q2_2[5]);
    }
  }
  ...
  // formatting statements
      if (pi0 != 1){h1_toPlot[i]->Rebin(4);} // Halve the number of bins when not pi0. Comment out (or delete) if unnecesary
      else {h1_toPlot[i]->Rebin(10);} // Decrease the number of bins for pi0 (much fewer events than the others). Comment out (or delete) if unnecesary
      h1_toPlot[i]->Sumw2();
  //       h1_el_phientum[i]->Scale( 1./h1_el_momentum[i]->Integral(),"width"); // normalize the histogram to 1
      ...
      h1_toPlot[i]->GetXaxis()->SetTitle("Q^{2} (GeV^{2})");
      if (pi0 != 1){h1_toPlot[i]->GetYaxis()->SetTitle("Events per 40 MeV");}
      else {h1_toPlot[i]->GetYaxis()->SetTitle("Events per 100 MeV");}
  ...
  //        h1_el_momentum[i]->GetYaxis()->SetTitleSize( 0.06);
        ...
        h1_toPlot[i]->SetTitle("Q^{2} Distribution of (1e"+TString(numProt)+"p1pi) Events "+TString(accept) + " for "+TString(types));
  ...
  save_file_path = "../output/h1_pion_q2/"+TString(energ)+TString(nucleus)+TString(cuts)+TString(particles)+TString(numProt)+"P"+TString(a)+".pdf";
